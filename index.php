...
<head>
    ...
    <meta property="og:site_name" content="Pia's Schedule__"/>
    <meta property="og:title" content="Pia's Schedule__"/>
    <meta property="og:type" content="website"/>
    <meta property="og:description" content="Pia's Schedule__"/>
                            ...
                            <div class="inner">
                                <div>
                                    ...
                                    <div id="image02" class="image">
                                        <span class="frame">
                                            <img src="assets/images/image02.jpg?v=9cfdc8b0" alt=""/>
                                        </span>
                                    </div>
                    ...
                    <div id="container08" class="container columns">
                        <div class="wrapper">
                            <div class="inner">
                                <div>
                                    <p id="text23">
                                        <a href="#home">yesterday</a>
                                    </p>
                                </div>
                                <div>
                                    <p id="text24">
                                        <a href="#stanlist">today</a>
                                    </p>
                                </div>
                                <div>
                                    <p id="text25">
                                        <a href="#luvs">tomorrow</a>
                                    </p>
                                </div>
                            </div>
                        </div>
                ...
                <section id="home-section">
                    <div id="container03" class="container columns">
                        <div class="wrapper">
                            <div class="inner">
                                <div>
                                    <h1 id="text13">⠀ ͏͏͏͏͏͏ ͏͏͏͏͏͏ ͏͏͏͏͏͏ ͏͏͏͏͏͏</h1>
                                    <h1 id="text20">⠀ ͏͏͏͏͏͏ ͏͏͏͏͏͏ ͏͏͏͏͏͏ ͏͏͏͏͏͏</h1>
                                </div>
                                <div>
                                    ...
                                    <h1 id="text15">
                                        <span class="p">
                                            <mark>
                                                ⠀⠀⠀
                                                <strong>to be done yesterday:</strong>
                                                ⠀⠀⠀
                                            </mark>
                                            <br/>
                                             example text for tasks that should have been done yesterday
                                        </span>
                                    </h1>
                                    <h1 id="text04">
                                        <span class="p">
                                ...
                                <div>
                                    ...
                                    <h1 id="text15">
                                        <span class="p">
                                            ...
                                            <br/>
                                             example text for tasks that are to do
                                        </span>a
                                    </h1>
                                    <h1 id="text04">
                                        <span class="p">
                        ...
                        <div class="wrapper">
                            <div class="inner">
                                <h1 id="text06">
                                    ...
                                    <strong>Stay strong! You got this.</strong>
                                </h1>
                            </div>
                        </div>
                    </div>
